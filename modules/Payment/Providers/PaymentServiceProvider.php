...
use Modules\Payment\Observers\PaymentTypeObserver;
use Modules\Payment\Repositories\PaymentTypeRepository;
use Modules\Payment\Repositories\PaymentTypeSettingRepository;
...
class PaymentServiceProvider extends ServiceProvider
{
    ...
    private function registerRepositories()
    {
        ...
        $this->app->bind(IPaymentTypeSettingRepository::class, PaymentTypeSettingRepository::class);
    }
